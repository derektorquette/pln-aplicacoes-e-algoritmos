...
stop2.append('aa') #personalizada

splitter = re.compile('\\W+') # \\W caractere que não seja palavra
stemmer = nltk.stem.RSLPStemmer() #usado para PTbr
lista_palavras = []
